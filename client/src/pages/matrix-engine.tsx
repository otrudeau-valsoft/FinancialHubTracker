...
// Mock thresholds based on stock classification and rating (in a real app, these would come from your database)
const MOCK_THRESHOLDS = {
  ...
  // Additional thresholds would be added here for all rule types
};
...
const RuleThresholdCard = ({ ruleType, ruleId, ruleName, description }: { ruleType: string, ruleId: string, ruleName: string, description: string }) => {
  ...
  const thresholds = MOCK_THRESHOLDS[ruleId as keyof typeof MOCK_THRESHOLDS] || {
